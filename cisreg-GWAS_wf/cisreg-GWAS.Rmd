...
parameters <- list(
  ...
  population = "EUR",  ## BEWARE, the population should be adapted to the query !
  # population = "AFR",  ## BEWARE, the population should be adapted to the query !
  working.dir = getwd(),
  output.dir = file.path(Sys.getenv("HOME"), "cisreg-GWAS_results"),
  r2 = 0.8,
  ld.distance = 200,
...
message("Results directory\t", parameters$result.dir)
...
message("Figures directory\t", parameters$figure.dir)
...
#   fig.path = 
#     file.path(parameters$figure.dir, 
#               paste0(parameters$query, "_")))
...
knitr::opts_chunk$set(
  ...
  encoding = "UTF-8",
  ## PROBLEM
  ## Maybe related to these reported issue:
  ##     https://github.com/rstudio/rmarkdown/issues/429
  ##     https://github.com/rstudio/rmarkdown/issues/587
#  fig.path = "figures/",
  fig.path = file.path(parameters$figure.dir, paste0(parameters$query, "_")),
#  fig.path = file.path("figures", paste0(parameters$query, "_")),
  size = "tiny", 
  warning = FALSE, 
  results = TRUE, 
  message = FALSE, 
...
outfiles["Parameters (yaml)"] <- file.path(parameters$result.dir, "parameters.yaml")
...
eTerm <- xEnricherSNPs(
  ...
  ontology = c("EF", 
               ...
               "EF_phenotype", 
               "EF_bp"), 
  include.LD = parameters$population,
  LD.r2 = parameters$r2,
