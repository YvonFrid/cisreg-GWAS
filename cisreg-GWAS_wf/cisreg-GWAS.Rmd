...
outfiles["Parameters"] <- file.path(parameters$result.dir, "parameters.tsv")
write.table(t(as.data.frame(parameters)), file = outfiles["Parameters"], 
            quote = FALSE, row.names = TRUE, col.names = FALSE, sep= "\t")
message("Parameters saved in file\t", outfiles["Parameters"])
