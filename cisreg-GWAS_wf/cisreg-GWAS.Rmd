...
ENS <- unique(na.omit(rSNPs.info$ensembl_gene_id))
...
## Plot of the functional annotation of each gene corresponding to rSNPs
...
entrez.gene.id <- na.omit(rSNPs.info$entrezgene_id)
