...
remapBedFile <-  paste(sep = "", parameters$dir$data, "/remap2018_all_macs2_hg38_v1_2.bed.gz")

# Define the path to saving .Rda file
remapRdataFile <- file.path(parameters$dir$data,
