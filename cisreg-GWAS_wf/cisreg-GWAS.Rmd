...
```{r varscan_snps_per_motif, fig.cap=paste(sep="", "**Figure ",(fig.nb <- fig.nb +1),". Distribution of TFBS potentially affected by each SOI from variation-scan results.** "), out.width = "10s0%", fig.width=10, fig.height=4.5}
...
barplot(sort(table(remap.SOI.overlaps$TF), decreasing = FALSE),
        main = "ReMap peaks / rSNP overlaps per factor",
        las = 2, 
        cex.names = 0.7, 
        col = "#37A3F3", 
        border = "#05245F",
