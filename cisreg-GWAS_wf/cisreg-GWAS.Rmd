...
## Print the summmary
kable(as.data.frame(DAsnpsSummary), 
...
# Kable
kable(head(LdSNPs), caption = "Top of the table describing the variants in Linkage disequilibrium (LD) with disease-associated SNPs within the window size of set to ", parameters$ld.distance, "kb")
